    ...
    if (
      ...
      timeout.current = setTimeout(() => {
        ...
        timeline
          ...
          .to(img3Ref.current, { x: -200, y: 200 }, '<')
          .to(img4Ref.current, { x: 350, y: -50 }, '<')
          .to(img5Ref.current, { x: 320, y: 70 }, '<')
          .to(img6Ref.current, { x: 360, y: 180 }, '<');
    ...
    <Wrapper ref={triggerRef}>
      <CardWrapper>
        <StageCard
          ...
          IconComponent={SvgCode}
        />
      </CardWrapper>
      <Image1 ref={img1Ref} src="/assets/images/stage-3-1.png" alt={tTitle} />
      <Image2 ref={img2Ref} src="/assets/images/stage-3-2.png" alt={tTitle} />
      <Image3 ref={img3Ref} src="/assets/images/stage-3-3.png" alt={tTitle} />
      <Image4 ref={img4Ref} src="/assets/images/stage-3-4.png" alt={tTitle} />
      <Image5 ref={img5Ref} src="/assets/images/stage-3-5.png" alt={tTitle} />
      <Image6 ref={img6Ref} src="/assets/images/stage-3-6.png" alt={tTitle} />
    </Wrapper>
  );
};
